...
class UploadFilesTesteUnit extends TestCase
{
    private $obj;
    ...
    public function testDeleteOldFiles()
    {
        ...
        $file2 = UploadedFile::fake()->create('video1.mp4')->size(1);
        $this->obj->uploadFiles([$file1, $file2]);
    ...
    {
        $attributes = [];
        $files = UploadFilesStubs::extractField($attributes);
        ...
        $attributes = ['file1' => 'teste', 'file2' => 'teste2'];
        $files = UploadFilesStubs::extractField($attributes);
        $this->assertCount(2, $attributes);
        $this->assertEquals(['file1' => 'teste', 'file2' => 'teste2'], $attributes);
        $this->assertCount(0, $files);
